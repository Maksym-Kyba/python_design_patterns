...
#Найголовніша різниця це те, що type() не спрацює якщо клас наслідує інший і ми хочемо перевірити саме на батька
#По друге isinstance підтримує LSP і легша в написанні
