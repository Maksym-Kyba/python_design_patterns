...
#Тут ми поєднуємо Memoization i Lazy Loading
#Memoization потрібна для пришвидшення майбутніх завантажень
#Lazy Loading як і завжди відкладає на потім момент завантаження даних
