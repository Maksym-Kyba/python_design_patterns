...
#Наші білдери мають однаковий набір функцій, але вони працюють по різному
#Офіціант не знає як готувати піцу, але він знає яку піцу готувати і він має рецепт
#Дуже легко буде розширити меню піц просто додавши білдера
