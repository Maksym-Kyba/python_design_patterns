...
#Файл _database створює базу даних (генерує рандомні цитати і записує в базу даних
#Цей файл це наш клієнт. Спочатку ми дивимось чи є запит клієнт в кеші (Redis)
#Якщо все таки нема то звертаємось у датабазу і оновлюємо дані нашого кешу
#Кеш ми створили на початку цбого файлу (cache = redis...)
