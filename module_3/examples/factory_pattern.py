...
#Ми створили extract_factory який точно не знає який формат отримає
#Отже невідомо, який буде інпут
#Але він здатний обробляти обидва формати які нам потрібні
