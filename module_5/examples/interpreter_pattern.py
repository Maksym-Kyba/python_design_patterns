...
#Це все по факту просто використання на практиці формальних граматик
#State Pattern більше працює з регулярними шраматиками які легко описуються для автоматів
#Interpreter Pattern більше працює з контекстно-вільними мовами
