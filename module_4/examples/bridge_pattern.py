...
#Нехай ми маємо абстракцію ResourceContentFetcher і два низькорівневі класи
#Ці класи LocalFileFetcher та URLFetcher працюють по протоколу їх абстракції
#Мостом тут служить ResourceContent яка прйимає _imp (імплементація якого фетчера)
#Міст не знає як читаються дані, але ми йому в _imp даємо якийсь конкретний зчитувач
#Коли міст буде fetch він це зробить як _imp це робить
