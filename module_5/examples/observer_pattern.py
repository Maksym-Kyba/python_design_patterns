...
#Наша станція знає як змінюється погода, і її любить певна аудиторія, тому вона підписалась на цю станцію
#Кожному стежачу (App/Device) ми дали метод update
#WeatherStation користоується цим методом і сповіщає своїх підписників про зміни у погоді
#Це хороший приклад Loose Coupling. Поки в будь-якого девайсу є update, він буде отримувати оновлення
#Ще одна перевага - можливість видаляти підписників прямо під час роботи
