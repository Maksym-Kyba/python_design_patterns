...
#Memento pattern дуже подібний на Command Pattern
#Тут ми його застосовуємо щоб зберншти інформацію на майбутнє і використати за потреби
#Якби в нас був складніший обʼєкт з більшою кількістю атрибутів, то просто робити копію було б складно
#Memento зберігає лише дані а не цілу копію обʼєкта тому займає набагато менше місця
#Створення копії також може поламати програму коли ми захочемо повернутисб до старої версії
#Memento в цьому плані похожий на OSP: ми просто дописуємо щось
