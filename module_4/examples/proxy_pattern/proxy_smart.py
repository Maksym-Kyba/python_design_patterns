...
#Тут наш проксі бере на себе відповідальність за створення та закриття обʼєкту.
#Наприклад екземпляр DBConnection створюється лише при першому запиті (Lazy Proxy)
#Також проксі менеджить закриття (ми прописуємо йому ситуацію, коли обʼєкт вже не потрібен)
