...
#Нехай ми створюємо систему для операцій над файлами
#В нас є RemoteSevricee який власне це все і виконує
#Але юзео інтерактує з нашим проксі - ProxyService (у нього також можна запихнути багато перевірок для безпеки)
#Користоувач навіть не підозрює де і на якому сервері його файл. Цим займається проксі
#Також проксі може перетворити мій запит на зрозумілий серверу формат
